...
namespace CSP_futoshiki_skyscrapper.Utils
{
    class Utilities
    {
        ...
        public enum HEURISTIC_TYPE_ENUM { MOST_LIMITED, GREEDY, SMALL_DOMAIN}
        public enum ALGORITHM_TYPE_ENUM { BACKTRACKING, FORWARD_CHECKING}

        public const string SOUND_FILE_NAME = @"sound.wav";
        public const string CSV_SAVE_LOCATION_STATISTICS = @"C:\CSP\CSPResults\Statistics\";
        public const string CSV_SAVE_LOCATION_SOLUTION = @"C:\CSP\CSPResults\Solutions\";


        public const string FILE_NAME = @"Data_bad\test_sky_4_4.txt";
        ...
        public const HEURISTIC_TYPE_ENUM HEURISTIC_TYPE = HEURISTIC_TYPE_ENUM.MOST_LIMITED;
        public const ALGORITHM_TYPE_ENUM ALGORITHM_TYPE = ALGORITHM_TYPE_ENUM.FORWARD_CHECKING;
